...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _fontsAsFriends = __webpack_require__(54);

	var _fontsAsFriends2 = _interopRequireDefault(_fontsAsFriends);

	var _cssBoxModel = __webpack_require__(56);

	var _cssBoxModel2 = _interopRequireDefault(_cssBoxModel);

	var _informationalArticle = __webpack_require__(57);

	var _informationalArticle2 = _interopRequireDefault(_informationalArticle);

	var _productLandingPageHtmlOnly = __webpack_require__(58);

	var _productLandingPageHtmlOnly2 = _interopRequireDefault(_productLandingPageHtmlOnly);

	var _tributePageTestsHtmlOnly = __webpack_require__(59);

	var _tributePageTestsHtmlOnly2 = _interopRequireDefault(_tributePageTestsHtmlOnly);

	var _tributePageTestsII = __webpack_require__(60);

	var _tributePageTestsII2 = _interopRequireDefault(_tributePageTestsII);
	...
	*/
	...
	(0, _jquery2.default)(document).ready(function () {
	  ...
	  if (isChrome === false) {
	    alertOnce('Intro Alert', 'Test suites are currently optimized for the Chrome browser. Please ' + 'use Chrome for the best user experience. ' + 'Thanks and Happy Coding!');
	  }
	...
	function FCCInitTestRunner() {
	  ...
	  switch (hardCodedProjectName || localStorage.getItem('project_selector')) {
	    ...
	    case 'tribute-page-html-only':
	      ...
	      break;
	    case 'tribute-page':
	      (0, _tributePageTestsII2.default)();
	      break;
	    case 'drum-machine':
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = createFontsAsFriendsTests;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = createInformationalArticleTests;
	...
	function createTributePageTests() {
	  ...
	  describe('#Tribute Page tests', function () {
	    ...
	    describe('#Layout', function () {
	      ...
	      reqNum++;
	      it(reqNum + '. Your CSS must include a style using a class selector of ".main-column". The style should use an auto margin and have a width of 70% so that all elements with this class will be centered.', function () {

	        // Filter to get the .main-column rule.
	        var mainColumnRule = (0, _styleSheetUtils.allCSSRulesAsArray)(document.styleSheets).filter(function (rule) {
	          return !(0, _styleSheetUtils.isTestSuiteRule)(rule);
	        }).filter(function (rule) {
	          return rule.selectorText === '.main-column';
	        });

	        _chai.assert.equal(mainColumnRule.length, 1, 'Could not find a style with class selector ".main-column"');

	        _chai.assert.equal(mainColumnRule[0].style.margin, '0px auto', 'The style with class selector ".main-column" does not have a margin of "0 auto"');

	        _chai.assert.equal(mainColumnRule[0].style.width, '70%', 'The style with class selector ".main-column" does not have a width of "70%"');
	      });

	      reqNum++;
	      it(reqNum + '. Change the style with selector ".main-column" to use a background-color of "#96CFE5" so you can see the size of the elements that use this class.', function () {
	        ...
	        _chai.assert.equal(mainColumnRule[0].style['background-color'], 'rgb(150, 207, 229)', 'The style with class selector ".main-column" does not have a background-color of "#96CFE5"');
	      });

	      reqNum++;
	      it(reqNum + '. Your CSS must include a style using a class selector of ".page-title". The style should give a bottom and top margin of "20px" and use the text-align property with a value of "center".', function () {

	        // Filter to get the CSS rule.
	        var cssRule = (0, _styleSheetUtils.allCSSRulesAsArray)(document.styleSheets).filter(function (rule) {
	          return !(0, _styleSheetUtils.isTestSuiteRule)(rule);
	        }).filter(function (rule) {
	          return rule.selectorText === '.page-title';
	        });

	        _chai.assert.equal(cssRule.length, 1, 'Could not find a style with class selector .page-title');

	        _chai.assert.equal(cssRule[0].style['margin-top'], '20px', 'The style with class selector ".page-title" does not have a margin-top of "20px"');

	        _chai.assert.equal(cssRule[0].style['margin-bottom'], '20px', 'The style with class selector ".page-title" does not have a margin-bottom of "20px"');

	        _chai.assert.equal(cssRule[0].style['text-align'], 'center', 'The style with class selector ".page-title" does not have a text-align property with the value of "center"');
	      });

	      reqNum++;
	      it(reqNum + '. Your <h1> element with class "page-title" must also have the class "main-column".', function () {

	        var elem = document.querySelector('h1.page-title.main-column');

	        _chai.assert.isNotNull(elem, 'Could not find an <h1> element with the classes "page-title" and "main-column"');
	      });

	      reqNum++;
	      it(reqNum + '. Your CSS must include a style using a class selector of ".page-subtitle". The style should give a bottom margin of "15px" and use the text-align property with a value of "center".', function () {

	        // Filter to get the CSS rule.
	        var cssRule = (0, _styleSheetUtils.allCSSRulesAsArray)(document.styleSheets).filter(function (rule) {
	          return !(0, _styleSheetUtils.isTestSuiteRule)(rule);
	        }).filter(function (rule) {
	          return rule.selectorText === '.page-subtitle';
	        });

	        _chai.assert.equal(cssRule.length, 1, 'Could not find a style with class selector .page-subtitle');

	        _chai.assert.equal(cssRule[0].style['margin-bottom'], '15px', 'The style with class selector ".page-subtitle" does not have a margin-bottom of "15px"');

	        _chai.assert.equal(cssRule[0].style['text-align'], 'center', 'The style with class selector ".page-subtitle" does not have a text-align property with the value of "center"');
	      });

	      reqNum++;
	      it(reqNum + '. Your <h2> element with class "page-subtitle" must also have the class "main-column" so that it is centered.', function () {

	        var elem = document.querySelector('h2.page-subtitle.main-column');

	        _chai.assert.isNotNull(elem, 'Could not find an <h2> element with the classes "page-subtitle" and "main-column"');
	      });

	      reqNum++;
	      it(reqNum + '. Your <img> element with class "tribute-photo" must also have the class "main-column".', function () {

	        var elem = document.querySelector('img.tribute-photo.main-column');

	        _chai.assert.isNotNull(elem, 'Could not find an <img> element with the classes "tribute-photo" and "main-column"');
	      });

	      reqNum++;
	      it(reqNum + '. Your CSS must include a style using a class selector of ".tribute-photo". The style should have a "display" property with a value of "block" so that the image is centered.', function () {

	        // Filter to get the CSS rule.
	        var cssRule = (0, _styleSheetUtils.allCSSRulesAsArray)(document.styleSheets).filter(function (rule) {
	          return !(0, _styleSheetUtils.isTestSuiteRule)(rule);
	        }).filter(function (rule) {
	          return rule.selectorText === '.tribute-photo';
	        });

	        _chai.assert.equal(cssRule.length, 1, 'Could not find a style with class selector .tribute-photo');

	        _chai.assert.equal(cssRule[0].style['display'], 'block', 'The style with class selector ".tribute-photo" does not have a "display" property with the value of "block"');
	      });

	      reqNum++;
	      it(reqNum + '. Your CSS must include a style using a class selector of ".img-caption". The style should have a top margin of "0px" and use the text-align property with a value of "center".', function () {

	        // Filter to get the CSS rule.
	        var cssRule = (0, _styleSheetUtils.allCSSRulesAsArray)(document.styleSheets).filter(function (rule) {
	          return !(0, _styleSheetUtils.isTestSuiteRule)(rule);
	        }).filter(function (rule) {
	          return rule.selectorText === '.img-caption';
	        });

	        _chai.assert.equal(cssRule.length, 1, 'Could not find a style with class selector .img-caption');

	        _chai.assert.equal(cssRule[0].style['margin-top'], '0px', 'The style with class selector ".img-caption" does not have a margin-top property with the value of "0px"');

	        _chai.assert.equal(cssRule[0].style['text-align'], 'center', 'The style with class selector ".img-caption" does not have a text-align property with the value of "center"');
	      });

	      reqNum++;
	      it(reqNum + '. Your <div> element with class "img-caption" must also have the class "main-column".', function () {

	        var elem = document.querySelector('div.img-caption.main-column');

	        _chai.assert.isNotNull(elem, 'Could not find an <div> element with the classes "img-caption" and "main-column"');
	      });

	      reqNum++;
	      it(reqNum + '. Your CSS must include a style using a class selector of ".timeline-heading". The style should give a top margin of "30px" and use the text-align property with a value of "center".', function () {

	        // Filter to get the CSS rule.
	        var cssRule = (0, _styleSheetUtils.allCSSRulesAsArray)(document.styleSheets).filter(function (rule) {
	          return !(0, _styleSheetUtils.isTestSuiteRule)(rule);
	        }).filter(function (rule) {
	          return rule.selectorText === '.timeline-heading';
	        });

	        _chai.assert.equal(cssRule.length, 1, 'Could not find a style with class selector .timeline-heading');

	        _chai.assert.equal(cssRule[0].style['margin-top'], '30px', 'The style with class selector ".timeline-heading" does not have a margin-top of "30px"');

	        _chai.assert.equal(cssRule[0].style['text-align'], 'center', 'The style with class selector ".timeline-heading" does not have a text-align property with the value of "center"');
	      });

	      reqNum++;
	      it(reqNum + '. Your <h3> element with class "timeline-heading" must also have the class "main-column".', function () {

	        var elem = document.querySelector('h3.timeline-heading.main-column');

	        _chai.assert.isNotNull(elem, 'Could not find an <h3> element with the classes "timeline-heading" and "main-column"');
	      });

	      reqNum++;
	      it(reqNum + '. Your CSS must include a style using a class selector of ".timeline". The style should give use auto margins and a width of 60% so the elements using this style will be centered, but narrower than the main column..', function () {

	        // Filter to get the CSS rule.
	        var cssRule = (0, _styleSheetUtils.allCSSRulesAsArray)(document.styleSheets).filter(function (rule) {
	          return !(0, _styleSheetUtils.isTestSuiteRule)(rule);
	        }).filter(function (rule) {
	          return rule.selectorText === '.timeline';
	        });

	        _chai.assert.equal(cssRule.length, 1, 'Could not find a style with class selector .timeline');

	        _chai.assert.equal(cssRule[0].style['margin'], '0px auto', 'The style with class selector ".timeline" does not have a margin of "0 auto"');

	        _chai.assert.equal(cssRule[0].style['width'], '60%', 'The style with class selector ".timeline" does not have a width of "60%"');
	      });

	      reqNum++;
	      it(reqNum + '. Your <li> elements inside your timeline unordered list should have a margin of 10px.', function () {

	        var elems = document.querySelectorAll('ul.timeline li');

	        var elemsMargin = Array.from(elems).filter(function (elem) {
	          return getComputedStyle(elem).getPropertyValue('margin') === '10px';
	        });

	        console.log(elemsMargin);
	        console.log('elemsMargin');

	        _chai.assert.isAbove(elems.length, 0, 'Could not find any list item elements inside your timeline unordered list.');

	        _chai.assert.equal(elems.length, elemsMargin.length, 'Not all <li> elements have a margin of 10px.');
	      });

	      // Blockquote should have a class of main column.
	      reqNum++;
	      it(reqNum + '. Your <blockquote> element with the "tribute-quote" class must also have the class "main-column".', function () {

	        var elem = document.querySelector('blockquote.tribute-quote.main-column');

	        _chai.assert.isNotNull(elem, 'Could not find a <blockquote> element with the classes "tribute-quote" and "main-column"');
	      });

	      // Blockquote should have font-style italic.
	      reqNum++;
	      it(reqNum + '. Your <blockquote> element with class "tribute-quote" should have a font-style of "italic".', function () {

	        var elem = document.querySelector('blockquote.tribute-quote');
	        var fontStyle = getComputedStyle(elem).getPropertyValue('font-style');

	        console.log(fontStyle);
	        console.log('fontStyle');

	        _chai.assert.equal(fontStyle, 'italic', 'The <blockquote> element with class "tribute-quote" does not have a font-style of "italic".');
	      });

	      reqNum++;
	      it(reqNum + '. Your <p> element with the "more-info" class must also have the class "main-column".', function () {

	        var elem = document.querySelector('p.more-info.main-column');

	        _chai.assert.isNotNull(elem, 'Could not find a <p> element with the classes "more-info" and "main-column"');
	      });

	      // More info margin-top: 20px;
	      reqNum++;
	      it(reqNum + '. Your <p> element with class "more-info" should have a top margin of "20px".', function () {

	        var elem = document.querySelector('p.more-info');
	        var marginStyle = getComputedStyle(elem).getPropertyValue('margin-top');

	        console.log(marginStyle);
	        console.log('marginStyle');

	        _chai.assert.equal(marginStyle, '20px', 'The <p> element with class "margin-top" does not have a margin-top of "20px".');
	      });

	      // More info margin-top: 20px;
	      reqNum++;
	      it(reqNum + '. Your <p> element with class "photo-credit" should have a font size of "12px".', function () {

	        var elem = document.querySelector('p.photo-credit');
	        var marginStyle = getComputedStyle(elem).getPropertyValue('font-size');

	        _chai.assert.equal(marginStyle, '12px', 'The <p> element with class "photo-credit" does not have a font-size of "12px".');
	      });

	      reqNum++;
	      it(reqNum + '. Your CSS must have a body element selector that gives the body a background color of "#96CFE5". You will no longer be able to see the size of each element, because this is the same background color you gave to the main column elements.', function () {

	        // Filter to get the body rule.
	        var cssRule = (0, _styleSheetUtils.allCSSRulesAsArray)(document.styleSheets).filter(function (rule) {
	          return !(0, _styleSheetUtils.isTestSuiteRule)(rule);
	        }).filter(function (rule) {
	          return rule.selectorText === 'body';
	        });

	        _chai.assert.equal(cssRule.length, 1, 'Could not find a style with element selector "body"');

	        _chai.assert.equal(cssRule[0].style['background-color'], 'rgb(150, 207, 229)', 'The style with element selector "body" does not have a background-color of "#96CFE5"');
	      });

	      reqNum++;
	      it(reqNum + '. The <img> element should be centered within its parent\n      element.', function () {
	        var img = document.querySelector('img.tribute-photo.main-column');
	        var imgParent = img.parentElement;
	        var imgLeft = img.getBoundingClientRect().left;
	        var imgRight = img.getBoundingClientRect().right;
	        var parentLeft = imgParent.getBoundingClientRect().left;
	        var parentRight = imgParent.getBoundingClientRect().right;
